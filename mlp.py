...
class MLP:
    ...
    def backward(self, dJdy_hat):
        ...
        dJdz2 = dJdz3 @ W2 # Shape linear2out @ L2outxl2in
        dJdz1 = self.f_function.backward(dJdz2, z1)
        print(dJdz3.shape)
        dJdW2 = dJdz3.T @  z2# linear2out  linear2inxbatch size

        self.grads["dJdW2"] = dJdW2.mean(0)
        self.grads["dJdb2"] = dJdz3.mean(0)
        self.grads["dJdW1"] = (dJdz1.T @ x).mean(0)
